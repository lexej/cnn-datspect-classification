...
(defined by lower and upper bound), while conclusive cases were those predicted outside this interval.
...
to ensure a similar number of inconclusive cases both below and above the pre-defined cutoff.
...
The measure was taken separately for each classification approach.
...
Therefore first the mean balanced accuracy function was interpolated using cubic spline interpolation.
