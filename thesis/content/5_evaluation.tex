...
\begin{figure}[ht]
  ...
  \begin{subfigure}{0.9\textwidth}
    ...
    in the PPMI dataset. For better illustration the area under the mean of the balanced accuracy is highlighted.}
...
\begin{figure}[ht]
  ...
  \begin{subfigure}{0.9\textwidth}
    ...
    \subcaption{Balanced accuracy on conclusive cases for a given mean percentage of inconclusive cases observed 
    in the MPH dataset. For better illustration the area under the mean of the balanced accuracy is highlighted.}
