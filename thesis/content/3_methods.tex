...
The unilateral [$^{123}$I]FP-CIT specific binding ratio (SBR) method was used as the main benchmark.
...
An in-depth description of the unilateral SBR method can be found in [46].
