...
and evaluated on test set cases (SBR values computed for test set cases).
The described procedure was performed for each of the ten random splits of the development dataset.
...
As hyperparameters, the Gini impurity was employed to assess split quality, 
