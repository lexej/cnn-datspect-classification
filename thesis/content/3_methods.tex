...
Therefore the $\text{mean} \pm \text{SD}$ (standard deviation) of the determined upper and lower bounds 
of the inconclusive interval, 
...
% Proportion of in inconclusive cases in test set vs. 
Also the observed $\text{mean} \pm \text{SD}$ proportion of inconclusive cases in the test set is calculated 
as a function of the proportion of inconclusive cases in the validation set.
